    ...
    return (
        <div className="container-fluid mx-auto">
            ...
            <div className="container-fluid text-center custom bg-dark">
                <h2>About Us</h2>
                <p>Welcome to TravelX, the world's largest professional travel agency based in Los Angeles. We provide our awesome services in more than 200 countries and territories worldwide.</p>
                <h3>Who are we?</h3>
                <p>TravelX was officially launched on August 5, 1999 in New York.</p>
